...
echo "Run model:"
cd $PROJECT_HOME
exec python -m notebooks.image_conversion --cancer "$cancer" --merge "False" --height 512 --width 408 --dataset "$dataset" --out_folder="/scratch_net/$dataserver/$USER/transformed/small_all_512x408"
