...
def pix2pix_discriminator(net, num_filters, padding=2):
...
def discriminator(image_batch, unused_conditioning=None, use_spectral_norm=False, is_training=False):
    ...
    with tf.contrib.framework.arg_scope(
        ...
        logits_4d, _ = pix2pix_discriminator(image_batch, num_filters=[64, 128, 256, 512])
