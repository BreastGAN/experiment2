...
flags.DEFINE_string('image_x_file', '/scratch_net/biwidl100/oskopek/transformed/traineval_512x408/healthy.tfrecord',
                    'File pattern of images in image set X')

flags.DEFINE_string('image_y_file', '/scratch_net/biwidl100/oskopek/transformed/traineval_512x408/cancer.tfrecord',
...
def _define_model(images_healthy, images_cancer, include_masks=True):
    ...
    flagged_discriminator = functools.partial(
            discriminator.discriminator, is_training=True, use_spectral_norm=FLAGS.use_spectral_norm)
